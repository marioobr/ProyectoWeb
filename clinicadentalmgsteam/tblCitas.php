<?php
include 'Entidades/Cita.php';
include 'Modelo/Cita.modelo.php';
include 'Control/Cita.control.php';

$modeloCita = new CitaModelo();

//variable de control
$varMsjNewCita = $_Get['msjNewCita'];
//variable de control
$varMsjEdiCita = $_Get['msjEditCita'];
$varDeLCita = $_GET['eliminado'];
?>
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>ClinicaDental GSMTEAM</title>
		...
		<link rel="stylesheet" href="assets/font-awesome/5.10.1/css/fontawesome.min.css" />
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php foreach($modeloCita->listarCita() as $r): ?>
															<tr>
																<td><?php echo $r->__GET('Fecha'); ?></td>
																<td><?php echo $r->__GET('HoraInicio');?></td>
																<td><?php echo $r->__GET('Estado');?></td>
																<td><?php echo $r->__GET('Doctor_idDoctor'); ?></td>
																<td><?php echo $r->__GET('Paciente_idPaciente'); ?></td>
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="EditarCita.php?idCita=<?php echo $r->__GET('idCita'); ?>"><i class="fas fa-edit bigger-130" title="Modificar"></i></a> &nbsp;&nbsp; <a class="red" href="Control/Cita.control.php?idCita=<?php echo $r->__GET('idCita'); ?>"><i class="fas fa-trash bigger-130" title="Eliminar"></i> </a>
																	</div>
																</td>
															</tr>
														<?php endforeach; ?>
