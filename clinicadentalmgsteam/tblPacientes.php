...
include 'Control/Paciente.control.php';

$modeloCita = new PacienteModelo();

if(!empty($_Get['msjNewPac'])){
	$varMsjNewCita = $_Get['msjNewPac'];
}
else{
	
$varMsjNewCita = 0;
}
if(!empty($_Get['msjEditPac'])){
	$varMsjEdiCita = $_Get['msjEditPac'];
}
else{
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php foreach($modeloCita->listarPac() as $r): ?>
															<tr>
																<td><?php echo $r->__GET('idPaciente'); ?></td>
																<td><?php echo $r->__GET('NoExpediente');?></td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="EditarPaciente.php?idPac=<?php echo $r->__GET('idPaciente'); ?>"><i class="fas fa-edit bigger-130" title="Modificar"></i></a> &nbsp;&nbsp; <a class="red" href="Control/Paciente.control.php?idPac=<?php echo $r->__GET('idPaciente'); ?>"><i class="fas fa-trash bigger-130" title="Eliminar"></i> </a>
																	</div>
																</td>
															</tr>
														<?php endforeach; ?>
